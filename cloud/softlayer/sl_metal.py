...
description:
  - Create a bare-metal server in SoftLayer.  This technique may be used to other SoftLayer hardware components such as storage, firewalls, and other 'packages'.  
